...
if __name__ == "__main__":
    ...
    subject = 2 # Select the subjectt for training
    ...
    model_name = 'LSTM'
    models_dic = {'LSTM': create_lstm_model, 'CNN': create_conv_model,
                  'FF': create_ff_model, 'KNEE_LSTM': knee_lstm_model}
    ...
    for subject in range(2, 3):
        ...
        r2, rmse, nrmse, y_true, y_pred = train_fit(
            ...
            eval_only=False, # Do you want to evaluate only (no training). Will load the best model if it exists
        ...
        plt.close()
    r2_results.to_csv("E:\Spring25\Capstone\\re_ver\\Result\\minh_kun_only_raw_200e\\R2_results.csv")
    rmse_results.to_csv("E:\Spring25\Capstone\\re_ver\\Result\\minh_kun_only_raw_200e\RMSE_results.csv")
    nrmse_results.to_csv("E:\Spring25\Capstone\\re_ver\\Result\\minh_kun_only_raw_200e\\NRMSE_results.csv")
